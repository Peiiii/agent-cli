...
var HelloPlugin = /** @class */ (function () {
        ...
        this.commands = {
            hello: {
                ...
                execute: function (args, context) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        name = args[0] || 'World';
                        context.logger.info("Hello, ".concat(name, "!"));
                        return [2 /*return*/];
                    });
                }); }
            },
            bye: {
                ...
                execute: function (args, context) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        name = args[0] || 'World';
                        context.logger.info("Goodbye, ".concat(name, "!"));
                        return [2 /*return*/];
                    });
                }); }
            }
    ...
    HelloPlugin.prototype.onLoad = function () {
    ...
    HelloPlugin.prototype.onUnload = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
